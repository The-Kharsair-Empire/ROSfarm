...
b (8.000 | 0.000)b (7.000 | 0.000)b (6.000 | 0.001)b (5.000 | 0.002)b (4.000 | 0.004)b (3.000 | 0.005)b (2.000 | 0.006)b (1.000 | 0.007)
...
0.002: (move soilsensorpos a5)  [0.001]
0.003: (move a5 wateringnozzlepos)  [0.001]
0.004: (pick_up_tool wateringnozzlepos wateringnozzle)  [0.001]
0.005: (move wateringnozzlepos a5)  [0.001]
0.006: (water_plant a5 carrot)  [0.001]
0.007: (move a5 a1)  [0.001]
0.008: (water_plant a1 carrot)  [0.001]

 * All goal deadlines now no later than 0.008

Resorting to best-first search
b (8.000 | 0.000)b (7.000 | 0.000)b (6.000 | 0.001)b (5.000 | 0.002)b (4.000 | 0.003)b (3.000 | 0.004)b (2.000 | 0.005)b (1.000 | 0.006)
; Plan found with metric 0.007
; States evaluated so far: 161
; Time 0.05
0.000: (skip_water_plant a6 parsley)  [0.001]
0.000: (skip_water_plant a3 basil)  [0.001]
0.000: (move a5 soilsensorpos)  [0.001]
...
0.004: (move wateringnozzlepos a5)  [0.001]
0.005: (water_plant a5 carrot)  [0.001]
0.006: (move a5 a1)  [0.001]
